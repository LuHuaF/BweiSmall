...
public class MoLiAdapter extends RecyclerView.Adapter<MoLiAdapter.ViewHolder> {
    private List<ReXiaoBean.ResultBean.MlssBean.CommodityListBeanXX> list;
    private Context context;

    public MoLiAdapter(List<ReXiaoBean.ResultBean.MlssBean.CommodityListBeanXX> list, Context context) {
        this.list = list;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.my_moli_item,parent,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            mImage = itemView.findViewById(R.id.Mo_Image);
            mJs = itemView.findViewById(R.id.Mo_Js);
            mPrice = itemView.findViewById(R.id.Mo_Jg);
        }
    }
